...
SRCBOTH=misc.c stacks.c output.c string.c block.c cdrom.c disk.c	\
    ...
    hw/pci.c hw/timer.c hw/rtc.c hw/dma.c hw/pic.c hw/usb.c	\
    hw/usb-uhci.c hw/usb-ohci.c hw/usb-ehci.c hw/usb-hid.c		\
    hw/usb-msc.c hw/usb-uas.c hw/blockcmd.c hw/ata.c	\
...
SRC32FLAT=$(SRCBOTH) post.c e820map.c malloc.c romfile.c x86.c		\
    ...
    sha1.c hw/pcidevice.c hw/ahci.c hw/pvscsi.c		\
    hw/usb-xhci.c hw/usb-hub.c hw/sdcard.c fw/shadow.c fw/pciinit.c	\
    fw/smm.c fw/smp.c	\
...
SRC32SEG=string.c output.c stacks.c hw/pci.c hw/serialio.c
